...
public class collectionBooking {
    public void collectionBooking (WebDriver driver, String todayDate, String env,String bookingType) throws ParseException, InterruptedException {

        int sqFt = 9;
        int promo = 1;
        String fName = "shakayb";
        String lName = "return fixes";
//        String email = "shakayb@bystored.com";
        String email = fName + ".3adsagie"+"@bystored.com";
...
//        select pick up date
       ...
       /* for(int i = 1; i <= monthsBetween; i++){
        ...
        String jobDate = (String) res.get("jobDate");
